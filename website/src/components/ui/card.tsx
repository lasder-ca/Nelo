...
function Card({ className, ...props }: React.ComponentProps<"div">) { return <div data-slot="card" className={cn("flex flex-col gap-6 rounded-2xl border border-border/80 bg-card/70 py-6 text-card-foreground shadow-sm backdrop-blur-xl", className)} {...props} /> }
